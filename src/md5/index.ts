 ...
 */
const md5: (str: string, bit?: number) => string = (str, bit) => {
  var sMessage = str;
  function RotateLeft(lValue: any, iShiftBits: any) { return (lValue << iShiftBits) | (lValue >>> (32 - iShiftBits)); }
  ...
  function ConvertToWordArray(sMessage: string) {
    var lWordCount;
